  ...
  <div class="select-div">
    <div class="model-selector-div">
      <button
          ...
          @click="showModelOptList = !showModelOptList"
      >
        <svg class="robot-svg"
        ...
        >
          <path
              d="M17.5 15.5C17.5 16.61 16.61 17.5 15.5 17.5S13.5 16.61 13.5 15.5 14.4 13.5 15.5 13.5 17.5 14.4 17.5
    ...
    <div
        class="model-option-div"
        v-show="showModelOptList"
        @mouseleave="showModelOptList=false"
